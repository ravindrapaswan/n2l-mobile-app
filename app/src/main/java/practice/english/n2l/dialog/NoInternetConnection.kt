...
import practice.english.n2l.databinding.DialogNetworkBinding


class NoInternetConnection (private val context: Activity, private val title:String, private val subTitle:String) : DialogFragment() {
    private lateinit var binding: DialogNetworkBinding
    companion object { const val TAG = "NoInternetConnection" }
