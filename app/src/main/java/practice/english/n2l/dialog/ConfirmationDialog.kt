...
class ConfirmationDialog(private val context: Activity, private val title:String, private val subTitle:String, private val confirmationImp: ConfirmationImp) : DialogFragment() {
    private lateinit var  binding: DialogConfirmationBinding
    companion object { const val TAG = "ConfirmationDialog" }
