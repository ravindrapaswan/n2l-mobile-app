...
class WarningDialog(private val context: Activity, private val title:String, private val subTitle:String) : DialogFragment() {
    private lateinit var binding: DialogWarningBinding
    companion object { const val TAG = "WarningDialog" }
