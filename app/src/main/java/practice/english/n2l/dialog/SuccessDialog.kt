...
import practice.english.n2l.databinding.DialogSuccessBinding

class SuccessDialog(private val context: Activity, private val title:String, private val subTitle:String, private val successImp: SuccessImp) : DialogFragment() {
    private lateinit var  binding: DialogSuccessBinding
    companion object { const val TAG = "SuccessDialog" }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            btnConfirm.setOnClickListener {
                successImp.onYes(context,dialog)
            }
        }
    }
