...
import practice.english.n2l.databinding.DialogErrorBinding


class ErrorDialog (private val context: Activity, private val title:String, private val subTitle:String) : DialogFragment() {
    private lateinit var  binding: DialogErrorBinding
    companion object { const val TAG = "ErrorDialog" }
